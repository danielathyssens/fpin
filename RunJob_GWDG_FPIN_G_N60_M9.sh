...
#SBATCH --job-name=GWDG_FPIN_G_N60_M9
...
#SBATCH --output=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_G_N60_M9_%j.log
#SBATCH --error=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_G_N60_M9_%j.err
...
RUN_NAME="fpin_g_n60_k9_unf_attn"
...
COMMON_ARGS=( \
  ...
  fixed_train_set=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/data/train_data/cvrp/uniform/targets/converted_npz/ \
)
