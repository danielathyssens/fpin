...
#SBATCH --job-name=GWDG_FPIN_G_N20_M3
...
#SBATCH --output=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_G_N20_M3_%j.log
#SBATCH --error=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_G_N20_M3_%j.err
...
RUN_NAME="fpin_g_n20_k3_unf_attn"
...
COMMON_ARGS=( \
  ...
  fixed_train_set=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/data/train_data/cvrp/uniform/targets/fc_hgs_clean/n20_k3/ \
)
