#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E3_N60_M6
#SBATCH --output=cluster_logs/RETRAIN_FPIN_E3_N60_M6_%j.log
#SBATCH --error=cluster_logs/RETRAIN_FPIN_E3_N60_M6_%j.err
#SBATCH --ntasks=1
...
python -u run_fpin.py \
  ...
  train_cfg.run_name=fpin_e3_n60_k6_unf_attn \
  fixed_train_set=/fs-home/data/thyssens/ra_data/train_data/cvrp/uniform/targets/fc_hgs_clean/n60_k6/
