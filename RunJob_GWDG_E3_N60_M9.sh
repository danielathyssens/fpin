...
# Note: N=60,M=9 intentionally uses the legacy converted_npz targets.
#SBATCH --job-name=GWDG_E3_N60_M9
...
#SBATCH --output=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_E3_N60_M9_%j.log
#SBATCH --error=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_E3_N60_M9_%j.err
...
# Auto-resume: if a prior run for this (N=60, M=9) cell left a usable
