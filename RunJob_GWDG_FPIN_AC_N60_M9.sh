#!/bin/bash
#SBATCH --job-name=GWDG_FPIN_AC_N60_M9
#SBATCH --partition=grete:shared
#SBATCH --nodes=1 --ntasks-per-node=1 -G A100:1 --time=48:00:00 --requeue
#SBATCH --mail-type=FAIL --mail-user=thyssens@ismll.de
#SBATCH --output=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_AC_N60_M9_%j.log
#SBATCH --error=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_AC_N60_M9_%j.err
set -eo pipefail
...
RUN_NAME="fpin_ac_n60_k9_unf_attn"
...
COMMON=( env=cvrp60_unf model=fpin hydra.job.chdir=true "hydra.run.dir=${RUN_DIR}" \
  ...
  "train_cfg.run_name=${RUN_NAME}" fixed_train_set=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/data/train_data/cvrp/uniform/targets/converted_npz/ )
