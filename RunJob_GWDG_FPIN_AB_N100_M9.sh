...
# F-PIN-AB: F-PIN-A + log-domain Sinkhorn softassign + PIM-aligned loss (add_demand_weights=True, start_weight=0.2, pen_w=0.1). + PIM 2022 MTSPSoftassign head.
# softassign_head=True + softassign_layers=3 + sinkhorn_assignment=False.
#SBATCH --job-name=GWDG_FPIN_AB_N100_M9
...
#SBATCH --output=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_AB_N100_M9_%j.log
#SBATCH --error=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_AB_N100_M9_%j.err
...
RUN_NAME="fpin_ab_n100_k9_unf_attn"
...
COMMON_ARGS=( \
  ...
  model_cfg.model_args.softassign_head=True model_cfg.model_args.softassign_log_domain=True \
