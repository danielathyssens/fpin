#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E3_N60_M7
#SBATCH --output=cluster_logs/RETRAIN_FPIN_E3_N60_M7_%j.log
#SBATCH --error=cluster_logs/RETRAIN_FPIN_E3_N60_M7_%j.err
#SBATCH --ntasks=1
...
python -u run_fpin.py \
  meta=train_base env=cvrp60_unf model=fpin hydra.job.chdir=true \
  ...
  fixed_train_set=/fs-home/data/thyssens/ra_data/train_data/cvrp/uniform/targets/fc_hgs_clean/n60_k7/
