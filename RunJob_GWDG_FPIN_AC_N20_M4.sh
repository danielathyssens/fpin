#!/bin/bash
#SBATCH --job-name=GWDG_FPIN_AC_N20_M4
#SBATCH --partition=grete:shared
#SBATCH --nodes=1 --ntasks-per-node=1 -G A100:1 --time=48:00:00 --requeue
#SBATCH --mail-type=FAIL --mail-user=thyssens@ismll.de
#SBATCH --output=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_AC_N20_M4_%j.log
#SBATCH --error=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_AC_N20_M4_%j.err
set -eo pipefail
...
RUN_NAME="fpin_ac_n20_k4_unf_attn"
