#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E3_N20_M3
#SBATCH --output=cluster_logs/RETRAIN_FPIN_E3_N20_M3_%j.log
#SBATCH --error=cluster_logs/RETRAIN_FPIN_E3_N20_M3_%j.err
#SBATCH --ntasks=1
...
python -u run_fpin.py \
  ...
  train_cfg.run_name=fpin_e3_n20_k3_unf_attn \
