...
from utils_all.basic_funcs import USE_GPU, zeros, ones, is_sorted, to_variable
from utils_all.get_path import greedy_path, make_valid, targ_as_lst
from utils_all.basic_funcs import sparse_dense_mul
from utils_all.learn_funcs import load_ckp
from data_utils.preprocess import import_test_data
...
def eval(opts):
    ...
    # parameters
    model_params = {'with_loads': False, 'attn_dotproduct': True, 'memory_efficient': True, 'bi_directional': False,
    ...
    # loss_params = {'simple_loss': False, 'no_perms': False, 'size_average': True, 'with_penalty': False,
    #               'with_direct_demand': False, 'with_loads_loss': False}
    ...
    VRP_model_restored = VRP_Net(model_specs['layers'], model_params['depot_dim'], model_params['cities_dim'],
                                 ...
                                 model_params['bi_directional'], model_params['attn_dotproduct'],
                                 model_params['memory_efficient'])
    ...
    with torch.no_grad():
        for test_instance in Kool_Test_X:
            ...
            VRP_probs_t, sol_t, VRP_loads_t, VRP_pred_demands_t, sample_path_b0_t = VRP_model_restored(depot_batch_t,
                                                                                                       custom_batch_t,
                                                                                                       fleet_batch_t,
                                                                                                       demand_batch_t,
                                                                                                       All_dists_batch_t)
