...
def preprocess(Kool_Test_Xdat,Kool_Test_Xdat_orig, get_clusters=True):
    #get cluster labels
    if get_clusters:
        ...
        #transform test data
        Kool_Test_X=transform_X2d_old(Kool_Test_Xdat,Kool_Test_Xdat_orig,nr_of_datapoints=len(Kool_Test_Xdat))
    return Kool_Test_X