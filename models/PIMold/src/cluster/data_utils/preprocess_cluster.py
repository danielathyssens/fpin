...
def import_trainval_data(vrp_solved, nr_files):
    ...
    y_i = torch.load('data/' + vrp_solved + '_new/targets_i_small.pt')
    y_v = torch.load('data/' + vrp_solved + '_new/targets_v_small.pt')
    y_s = torch.load('data/' + vrp_solved + '_new/targets_s_small.pt')
    ...
    return dat_X, y_i, y_v, y_s, dat_YLoad, y_dense
