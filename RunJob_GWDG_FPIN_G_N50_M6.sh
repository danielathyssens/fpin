...
#SBATCH --job-name=GWDG_FPIN_G_N50_M6
...
#SBATCH --output=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_G_N50_M6_%j.log
#SBATCH --error=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/cluster_logs/GWDG_FPIN_G_N50_M6_%j.err
...
RUN_NAME="fpin_g_n50_k6_unf_attn"
...
COMMON_ARGS=( \
  env=cvrp50_unf model=fpin hydra.job.chdir=true \
  ...
  fixed_train_set=/projects/extern/nhr/nhr_ni/nim00026/dir.project/daniela/data/train_data/cvrp/uniform/targets/fc_hgs_clean/n50_k6/ \
)
