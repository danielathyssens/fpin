#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E1_N50_M6
#SBATCH --output=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N50_M6_%j.log
#SBATCH --error=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N50_M6_%j.err
#SBATCH --ntasks=1
...
python -u run_fpin.py \
  ...
  model_cfg.model_args.max_fleet_length=6 \
