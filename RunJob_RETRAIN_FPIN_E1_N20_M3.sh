#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E1_N20_M3
#SBATCH --output=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N20_M3_%j.log
#SBATCH --error=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N20_M3_%j.err
#SBATCH --ntasks=1
...
python -u run_fpin.py \
  ...
  train_cfg.run_name=fpin_e1_n20_k3_unf_attn \
  fixed_train_set=/fs-home/data/thyssens/ra_data/train_data/cvrp/uniform/targets/fc_hgs_clean/n20_k3/
