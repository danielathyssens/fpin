#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E1_N100_M9
#SBATCH --output=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N100_M9_%j.log
#SBATCH --error=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N100_M9_%j.err
#SBATCH --ntasks=1
...
python -u run_fpin.py \
  ...
  model_cfg.model_args.max_fleet_length=9 \
  ...
  train_cfg.run_name=fpin_e1_n100_k9_unf_attn \
