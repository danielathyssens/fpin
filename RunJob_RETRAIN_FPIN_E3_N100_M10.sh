#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E3_N100_M10
#SBATCH --output=cluster_logs/RETRAIN_FPIN_E3_N100_M10_%j.log
#SBATCH --error=cluster_logs/RETRAIN_FPIN_E3_N100_M10_%j.err
#SBATCH --ntasks=1
