#!/bin/bash
#SBATCH --job-name=RETRAIN_FPIN_E1_N20_M4
#SBATCH --output=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N20_M4_%j.log
#SBATCH --error=/home/thyssens/fpin/cluster_logs/RETRAIN_FPIN_E1_N20_M4_%j.err
#SBATCH --ntasks=1
...
python -u run_fpin.py \
  ...
  model_cfg.model_args.max_fleet_length=4 \
  ...
  train_cfg.run_name=fpin_e1_n20_k4_unf_attn \
